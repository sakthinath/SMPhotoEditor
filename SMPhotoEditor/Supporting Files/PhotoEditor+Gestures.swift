...
extension SMPhotoEditorViewController : UIGestureRecognizerDelegate  {
    ...
    func moveView(view: UIView, recognizer: UIPanGestureRecognizer)  {
        ...
        safeAreaView.backgroundColor = #colorLiteral(red: 0.9490196078, green: 0.4470588235, blue: 0.4392156863, alpha: 0.9999997711).withAlphaComponent(0.7)
        view.superview?.bringSubviewToFront(view)
